    ...
    def precompute(cls, spos):
        ...
        if ti is not None:
            if ti.has_building and not ti.is_building_ally:
                ...
                if ti.has_turret:
                    info6.enemy_turret_hp += e_building_hp
        ...
        if ti is not None:
            if ti.has_building and not ti.is_building_ally:
                ...
                if ti.has_turret:
                    info7.enemy_turret_hp += e_building_hp
        ...
        if ti is not None:
            if ti.has_building and not ti.is_building_ally:
                ...
                if ti.has_turret:
                    info5.enemy_turret_hp += e_building_hp
        ...
        if ti is not None:
            if ti.has_building and not ti.is_building_ally:
                ...
                if ti.has_turret:
                    info0.enemy_turret_hp += e_building_hp
        ...
        if ti is not None:
            if ti.has_building and not ti.is_building_ally:
                ...
                if ti.has_turret:
                    info4.enemy_turret_hp += e_building_hp
                info5.enemy_building_hp += e_building_hp
                if ti.has_turret:
                    info5.enemy_turret_hp += e_building_hp
                info6.enemy_building_hp += e_building_hp
        ...
        if ti is not None:
            if ti.has_building and not ti.is_building_ally:
                ...
                if ti.has_turret:
                    info1.enemy_turret_hp += e_building_hp
                info7.enemy_building_hp += e_building_hp
                if ti.has_turret:
                    info7.enemy_turret_hp += e_building_hp
        ...
        if ti is not None:
            if ti.has_building and not ti.is_building_ally:
                ...
                if ti.has_turret:
                    info2.enemy_turret_hp += e_building_hp
                info6.enemy_building_hp += e_building_hp
                if ti.has_turret:
                    info6.enemy_turret_hp += e_building_hp
                info7.enemy_building_hp += e_building_hp
        ...
        if ti is not None:
            if ti.has_building and not ti.is_building_ally:
                ...
                if ti.has_turret:
                    info3.enemy_turret_hp += e_building_hp
                info4.enemy_building_hp += e_building_hp
                if ti.has_turret:
                    info4.enemy_turret_hp += e_building_hp
                info5.enemy_building_hp += e_building_hp
