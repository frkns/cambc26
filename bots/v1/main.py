        ...
        for x in range(W):
            ...
            for y in range(H):
                ...
                if tinfo is None:
                    cc[y] = 2
                    continue
                if tinfo.round == Globals.ct.get_current_round() and tinfo.has_builder_bot:
                    cc[y] = 1_000_000
                    continue
...
class Map:
    ...
    def fill_tile_info():
        ...
        for pos in ct.get_nearby_tiles(20):
            ...
            ti.has_builder_bot = builder_bot_id is not None
            ...
            if building_id is not None:
                ...
                if (etype == EntityType.ROAD or
                        ...
                        etype == EntityType.ARMOURED_CONVEYOR or (
                            ...
                            and ct.get_team(building_id) == Globals.my_team
                        )):
