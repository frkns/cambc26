...
class BuildManager:
    ...
    def can_afford_builder_bot() -> bool:
        ...
        return Cache.ti >= ti_cost and Cache.ax >= ax_cost
        ...
        for x in range(W):
            ...
            for y in range(H):
                ...
                if ti is None or (
                    ...
                    and not (ti.has_builder_bot and ti.round == cur_round)
...
class RouteToCore:
    ...
    def try_build_route(cls):
        ...
        # maybe dbuild -> build
        if BuildManager.can_dbuild_bridge(cls.from_pos):
