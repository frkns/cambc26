# v8_patch,  @ 2026-03-23 21:38:29 (local)
...
class MarketMaker:
    ...
    def harvester_payback(apos: Position) -> int:
        ...
        bridges, _ = BfsBureau.find_bridge_route(Globals.ct.get_position(), Unit.core_pos_list)
