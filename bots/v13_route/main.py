# v13_route,  @ 2026-03-31 21:10:14 (local)
...
class HealTargeter:
    ...
    def get_best_target(cls) -> Position | None:
        ...
        print(f'{best.position=} {best.building_heal=} {best.building_hp=}')
        return best.position
...
class RouteToCore:
    ...
    def try_build_route(cls):
        ...
        if first_target is None:
            ...
            cls.give_up()
            StateExplore.run(Explore.get_target()) # new
            return
